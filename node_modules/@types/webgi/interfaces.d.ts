...
export type TSceneEvents = 'sceneUpdate' | 'addSceneObject' | 'update' | 'textureAdded' | 'activeCameraChange' | 'textureUpdate' | 'renderCameraChange' | 'activeCameraUpdate' | 'sceneMaterialUpdate' | 'environmentChanged' | 'select' | 'objectUpdate' | 'materialUpdate' | 'materialChanged' | 'setView' | 'activateMain' | 'backgroundChanged';
